...
import { Wine, Utensils, DollarSign, ChefHat } from 'lucide-react'
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-zinc-400 text-sm">
              {restaurant_info.cuisine_style} • {result.menu_analysis.items_found} items found
            </p>
          </div>
        </div>
      </div>
          ...
          <div key={index} className="border border-zinc-800 rounded-lg p-3">
            ...
            <div className="mb-4">
              ...
              {item.dish.description && (
                <p className="text-zinc-300 text-sm mt-2">{item.dish.description}</p>
              )}
            </div>
